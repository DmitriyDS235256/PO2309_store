...
public class AppConst {
    ...
    public static final String VENDER_PARAM = "vender";
    ...
    public static final String PRICE_FROME_PARAM = "priceFrom";
    ...
    public static final String ITEM_TYPE_PARAM = "itemTipe";
    ...
    public static final String LAPTOP_ATTR = "laptops";
